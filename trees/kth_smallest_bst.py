...
def kth_smallest_bst(input_param):
    """
    Kth smallest in BST
    ...
    Examples:
        >>> kth_smallest_bst(test_input)
        expected_output
        
        >>> kth_smallest_bst(edge_case)
        edge_output
    """
...
def kth_smallest_bst_optimized(input_param):
    """
...
def test_kth_smallest_bst():
    ...
    print(f"Testing Kth Smallest Bst")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    print(f"\nKth Smallest Bst - Ready for implementation!")
