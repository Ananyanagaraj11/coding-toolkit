...
def num_1_bits(input_param):
    ...
    Examples:
        >>> num_1_bits(test_input)
        expected_output
        
        >>> num_1_bits(edge_case)
        edge_output
    """
...
def num_1_bits_optimized(input_param):
    """
...
if __name__ == "__main__":
    test_num_1_bits()
    print(f"\nNum 1 Bits - Ready for implementation!")
