...
Problem: Find needle in haystack
Difficulty: Easy
Category: Strings
Topic: String
...
def implement_strstr(input_param):
    """
    ...
    Examples:
        >>> implement_strstr(test_input)
        expected_output
        
        >>> implement_strstr(edge_case)
        edge_output
    """
...
def implement_strstr_optimized(input_param):
    """
...
if __name__ == "__main__":
    test_implement_strstr()
    print(f"\nImplement Strstr - Ready for implementation!")
