...
def binary_search(input_param):
    ...
    Examples:
        >>> binary_search(test_input)
        expected_output
        
        >>> binary_search(edge_case)
        edge_output
    """
...
def binary_search_optimized(input_param):
    """
...
if __name__ == "__main__":
    test_binary_search()
    print(f"\nBinary Search - Ready for implementation!")
