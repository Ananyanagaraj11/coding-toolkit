...
def insertion_sort(input_param):
    """
    ...
    Examples:
        >>> insertion_sort(test_input)
        expected_output
        
        >>> insertion_sort(edge_case)
        edge_output
    """
...
def insertion_sort_optimized(input_param):
    """
...
if __name__ == "__main__":
    test_insertion_sort()
    print(f"\nInsertion Sort - Ready for implementation!")
